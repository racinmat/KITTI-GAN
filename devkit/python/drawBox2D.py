...
def drawBox2D(h=None, box=None, occlusion=None, object_type=None):
    ...
    h[0]['axes'].add_patch(Rectangle((box['x1'], box['y1']), width=(box['x2'] - box['x1'] + 1), height=(box['y2'] - box['y1'] + 1), edgecolor=occ_col[int(occlusion) + 1], linewidth=6))
    h[0]['axes'].add_patch(Rectangle((box['x1'], box['y1']), width=(box['x2'] - box['x1'] + 1), height=(box['y2'] - box['y1'] + 1), edgecolor='k', linewidth=2))
    # plot label
