...
D_logits_fake = tf.placeholder(tf.float32, shape=[5], name='D_logits_fake')
D_fake = tf.nn.sigmoid(D_logits_fake)
...
x = [-1, -1, 0, 0, 1]
result_1, result_2 = sess.run([d_loss_fake, g_loss], feed_dict={D_logits_fake: x})
print(result_1)
print(result_2)
