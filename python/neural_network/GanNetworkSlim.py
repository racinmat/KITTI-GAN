...
class GanNetworkSlim:
    ...
    def build_model(self, data_set, batch_size, c_dim, z_dim, gfc_dim, gf_dim, l1_ratio, learning_rate, beta1, df_dim,
        ...
        with tf.variable_scope(self.scope_name):
            ...
            d_vars = slim.get_variables(scope=self.scope_name + '/' + discriminator_scope_name, collection=GraphKeys.TRAINABLE_VARIABLES)
            g_vars = slim.get_variables(scope=self.scope_name + '/' + generator_scope_name, collection=GraphKeys.TRAINABLE_VARIABLES)
